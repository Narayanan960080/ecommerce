                   ...
                   children:  [
                     ...
                     Row(
                       children: [
                         ...
                         const Text("Title",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                     ...
                     Row(
                       children: [
                         ...
                         SizedBox(
                             ...
                             child: Text(widget.data.details!.title.toString(),style: const TextStyle(color: Colors.black,fontSize: 13),maxLines: 6,overflow: TextOverflow.ellipsis,)),
                       ],
                     ),
                     Visibility(
                           ...
                           Row(
                             children: [
                               ...
                               SizedBox(
                                   ...
                                   child: Text(widget.data.details!.selftext.toString(),style: const TextStyle(color: Colors.black,fontSize: 13),maxLines: 6,overflow: TextOverflow.ellipsis,)),
                             ],
                           ),
                         ],
                       ),
                     ...
                     Row(
                       children: [
                         SizedBox(width: width * 0.04,),
                         Text(convertDate(widget.data.details!.created!.toInt()) ,style: const TextStyle(color: Colors.black,fontSize: 10),),
                       ],
                     )
                   ],
                 ))
